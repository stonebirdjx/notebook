...
- 文件系统：ceph、nfs、glusterfs、[open-local](https://github.com/alibaba/open-local/blob/main/docs/user-guide/user-guide_zh_CN.md)
...
- 动态存储类：rock-ceph、rock-nfs、open-local
- k8数据库：etcd
- 日志分析系统:
...
- 源站：内容诞生的地方(一般是客户方)、内容最后一道防线
- 中心节点：内容源、内容管理、内容容灾

- 边缘节点：该区域内用户就近访问的服务节点、承担用户请求
...
hertz、kitex、swagger、requestid 、trace、FFmpeg（ffprobe）
